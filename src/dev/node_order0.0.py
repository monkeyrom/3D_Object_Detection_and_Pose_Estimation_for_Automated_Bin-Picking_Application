    ...
    while True :
        ...
        if step == 0 and home_check == -1 :         # Check Robot and not found
            ...
            if obj_target1 == -1:                       # Object lost
                ...
                ry = obj_target1[4]
                rz = obj_target1[5]
                #pose_check = robot_check_pose(obj_target1[0],obj_target1[1],obj_target1[2]+30)  # Check Robot position (25 mm above object)
                sleep(0.5)
                if pose_check == 1 :                                                            # Robot at the position (25 mm above object)
