...
#model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/rai/catkin_ws/src/CR5_Project/src/train-models/best5.pt')
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # Show images
            cv2.namedWindow('CR5_Realsense (Depth)', cv2.WINDOW_AUTOSIZE)
            cv2.imshow('CR5_Realsense (Depth)', depth_colormap)
            key = cv2.waitKey(1)
